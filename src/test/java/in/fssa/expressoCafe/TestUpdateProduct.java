...
//    }
	...
	void testUpdateProductWithNonExistingProductId() {
		...
		Category category = new Category();
		category.setCategoryId(11); // Assuming category ID 10 does not exist
